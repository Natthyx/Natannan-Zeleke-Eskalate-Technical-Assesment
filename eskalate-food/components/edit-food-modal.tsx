...
import type { Food, FoodFormData } from "@/lib/food-service"
...
export function EditFoodModal({ isOpen, onClose, onSubmit, food, isSubmitting = false }: EditFoodModalProps) {
      ...
      <DialogContent className="sm:max-w-[400px] p-0">
        <div className="bg-white rounded-lg">
          <DialogHeader className="p-6 pb-4">
            <DialogTitle className="text-xl font-bold text-center text-orange-500">Edit Meal</DialogTitle>
          </DialogHeader>

          <form onSubmit={handleSubmit} className="px-6 pb-6 space-y-4">
            <div className="space-y-2">
              <Label htmlFor="edit_food_name" className="text-sm text-gray-600">
                Food name
              </Label>
              <Input
                id="edit_food_name"
            ...
            <div className="space-y-2">
              <Label htmlFor="edit_food_rating" className="text-sm text-gray-600">
                Food rating
              </Label>
              <Input
                id="edit_food_rating"
            ...
            <div className="space-y-2">
              <Label htmlFor="edit_food_image" className="text-sm text-gray-600">
                Food image (URL)
              </Label>
              <Input
                id="edit_food_image"
            ...
            <div className="space-y-2">
              <Label htmlFor="edit_restaurant_name" className="text-sm text-gray-600">
                Restaurant name
              </Label>
              <Input
            ...
            <div className="space-y-2">
              <Label htmlFor="edit_restaurant_logo" className="text-sm text-gray-600">
                Restaurant logo (URL)
              </Label>
              <Input
            ...
            <div className="space-y-2">
              <Label htmlFor="edit_restaurant_status" className="text-sm text-gray-600">
